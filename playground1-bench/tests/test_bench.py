#!/usr/bin/env python3
"""
Playground 1: Benchmark Demo Test

This demo shows how to benchmark code running on the Nucleo board.
The firmware prints benchmark results, and this script reads and displays them.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Playground 1: Benchmark Demo")
    parser.add_argument(
        "--platform",
        choices=["board", "qemu"],
        default="board",
    ...
    if args.platform == "qemu" and not args.elf:
        ...
        print(
            "Usage: python test_bench.py --platform qemu --elf ../build/bench-demo.elf"
        )
        sys.exit(1)
