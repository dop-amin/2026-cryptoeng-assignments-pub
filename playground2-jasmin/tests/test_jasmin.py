#!/usr/bin/env python3
"""
Playground 2: Jasmin Demo Test

This demo shows how to integrate a Jasmin function and benchmark it.
The firmware calls a Jasmin function in a loop and prints benchmark results.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Playground 2: Jasmin Demo")
    parser.add_argument(
        "--platform",
        choices=["board", "qemu"],
        default="board",
    ...
    if args.platform == "qemu" and not args.elf:
        ...
        print(
            (
                "Usage: python test_jasmin.py --platform qemu"
                "--elf ../build/jasmin-demo.elf"
            )
        )
        sys.exit(1)
